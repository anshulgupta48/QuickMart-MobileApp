...
const ForgotPassword = () => {
  const [forgotPasswordFormData, setForgotPasswordFormData] = useState({ email: '', password: '', confirmPassword: '' });
            ...
            <View className='w-full px-[16px] flex flex-col gap-[24px]'>
              {activeForgotPasswordIndex === 0 && <View className='flex flex-col gap-[16px]'>
                ...
                <View className='flex flex-col gap-[8px]'>
                  ...
                  <TextInput placeholder='Enter your Email' placeholderTextColor='#C0C0C0' value={forgotPasswordFormData.email} onChange={(e) => handleChange('email', e)} className='h-[60px] w-full px-[16px] border-[1.5px] border-solid border-lavender-haze focus:border-aqua-mint rounded-[12px] text-midnight-carbon text-[12px] font-inter-regular transition-all duration-300' />
                </View>
              </View>}
